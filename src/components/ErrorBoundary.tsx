        ...
        <Card variant="outlined" sx={{ maxWidth: 560 }} data-testid="error-boundary">
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
              Try again re-renders the page. If it keeps crashing, the saved
              map data may be the cause — Reset map data clears it (pins,
              drawings, routes, bookmarks and the saved viewport) and reloads.
            </Typography>
