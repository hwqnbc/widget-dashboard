 ...
 */
export type AvatarId = 'toy' | 'ninja' | 'fireninja' | 'darkarin' | 'frak' | 'imperium' | 'goldgunner' | 'scar' | 'bazookajoe' | 'lloyd'
...
export const AVATAR_IDS: AvatarId[] = ['toy', 'ninja', 'fireninja', 'darkarin', 'frak', 'imperium', 'goldgunner', 'scar', 'bazookajoe', 'lloyd']
