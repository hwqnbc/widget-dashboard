 ...
 */
export type AvatarId = 'toy' | 'ninja' | 'fireninja' | 'darkarin' | 'frak' | 'imperium' | 'goldgunner'
...
export const AVATAR_IDS: AvatarId[] = ['toy', 'ninja', 'fireninja', 'darkarin', 'frak', 'imperium', 'goldgunner']
