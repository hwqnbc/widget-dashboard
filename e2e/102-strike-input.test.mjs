...
await openStrikeSettings(page)
await page.locator('[data-testid="strike-gyro-always"]').click()
await page.waitForTimeout(150)
await closeStrikeSettings(page)
check('gyro mode round-trips', (await root.getAttribute('data-gyro')) === 'always')
await openStrikeSettings(page)
await page.locator('[data-testid="strike-gyro-off"]').click()
await page.waitForTimeout(150)
await closeStrikeSettings(page)
check('gyro mode returns to off', (await root.getAttribute('data-gyro')) === 'off')
