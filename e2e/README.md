...
| `105-strike-crash` | crash mode (default on): closed-loop full-speed wall ram → tumble + CRASHED! banner + one heart lost + pad respawn; pad rest restores the heart; safe-mode ram only pins; toggle persistence. Suites 100–102/104 disable crash mode after setup — their routes bump walls by design |
